...
const SUITES = [
  ...
  { id: 'verify-annual-sub', file: 'tests/verify-annual-sub.js', label: '年总替补轮换' },
  { id: 'verify-mode-sync', file: 'tests/verify-mode-sync.js', label: '三模式规则同步' },
  ...
  { id: 'verify-v2-econ', file: 'tests/verify-v2-econ.js', label: 'v2经济门禁' },
